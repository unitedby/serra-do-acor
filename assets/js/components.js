    ...
    connectedCallback() {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54">
          <g transform="translate(-1839.492 -1000.493)">
            <g class="ellipse-button-footer" transform="translate(1839.492 1000.493)" fill="none"  stroke-width="1.5">
              <circle cx="27" cy="27" r="27" stroke="none"/>
              <circle cx="27" cy="27" r="26.5" fill="none"/>
            </g>
            ...
            <div class="menu-header">
                ...
                <div class="header-right">
                    <div class="header-language">
                        <a href="${ptLink}">
                        <p class="language-selected">PT</p>
                        </a>
                        <p>·</p>
                        <a href="${enLink}">
                        <p>EN</p>
                        ...
                        <div id="menu-column2">
                            <div class="menu-container" id="menu-container6" onclick="window.location.href='historia1.html'">
                                <div class="menu-container-image">
                                    ...
                                    <div class="menu-title">
                                        <h3>História e Atividades humanas</h3>
                                    </div>
                                    <div class="menu-knowmore-1">
                                        <p>Saber mais</p>
                                        <img src="assets/data/icons/menu-arrow.svg">
